...
- [Charpter2 - MPLS架构](#Charpter2---MPLS架构)
  * [什么是MPLS标签](#什么是MPLS标签)
    + [标签栈](#标签栈)
    + [MPLS数据包编码](#MPLS数据包编码)
  ...
  * [不同的 MPLS 运行模式](#不同的-MPLS-运行模式)
    + [Label Distribution Modes - 标签分发机制](#Label-Distribution-Modes---标签分发机制)
    + [Label Retention Modes - 标签保留机制](#Label-Retention-Modes---标签保留机制)
    + [LSP Control Modes - LSP控制模式](#LSP-Control-Modes---LSP控制模式)
