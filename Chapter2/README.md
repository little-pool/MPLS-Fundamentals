...
- [Charpter2 - MPLS架构](#charpter2---mpls--)
  * [什么是MPLS标签](#---mpls--)
    + [标签栈](#---)
    + [MPLS数据包编码](#mpls-----)
  * [MPLS 和 OSI 参考模型](#mpls---osi-----)
  * [标签交换路由器](#-------)
  * [标签交换路径](#------)
  * [转发等价类 - FEC(Forwarding Equivalence Class)](#--------fec-forwarding-equivalence-class-)
  * [标签分发](#----)
  * [标签分发协议 LDP](#-------ldp)
  * [标签转发表 LFIB](#------lfib)
  * [MPLS 载荷](#mpls---)
  * [MPLS 标签空间](#mpls-----)
    + [Per-Interface Label Space](#per-interface-label-space)
    + [Per-Platform Label Space](#per-platform-label-space)
  * [不同的 MPLS 运行模式](#----mpls-----)
    + [Label Distribution Modes - 标签分发机制](#label-distribution-modes---------)
    + [Label Retention Modes - 标签保留机制](#label-retention-modes---------)
    + [LSP Control Modes - LSP控制模式](#lsp-control-modes---lsp----)
